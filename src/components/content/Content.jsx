    ...
    return (
        <>
                    ...
                    <div className="flex items-center col-span-4 lg:col-span-2 order-1 ">
                        <div className="text-[40px] font-bold mb-20">
                            ...
                            <div className="flex gap-2 py-2 items-center justify-center lg:justify-start">
                                <a href={resume} download='resume' className="p-4 border-black hover:bg-black hover:border-white hover:text-white transition duration-700 w-full text-sm justify-center flex cursor-pointer border md:w-2/5 lg:w-2/5">Download CV</a>
                            </div>
            ...
            <div className='bg-white'>
                <section id='about' className="container mx-auto px-4 pt-20 min-h-screen ">
                    ...
                    <div className="grid grid-cols-6 text-[#767676] text-[18px] ">
                        ...
                        <div className='col-span-6 lg:col-span-3 md:col-span-3'>
                            ...
                            <div className='text-black py-4 font-semibold '>
                                <button href={resume} download='resume' className="p-4 w-full hover:bg-black hover:border-white hover:text-white transition duration-700 border-black text-sm justify-center flex cursor-pointer border">Download CV</button>
                            </div>
                        </div>
            ...
            <section id='porto' className="container mx-auto px-4 py-20 min-h-screen items-center">
                                        ...
                                        <div className='flex gap-4 py-2 flex-wrap'>
                                            {
                                                item?.tools?.name.map((item, index) => (
                                                    <div key={index} className='border shadow-md p-2 font-semibold text-sm'>
                                                        {item}
                                                    </div>
